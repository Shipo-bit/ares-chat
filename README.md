...
El cliente web forma parte del proyecto Shipo, que permite conectarse a la red Ares Chat directamente desde el navegador, manteniendo compatibilidad con la infraestructura original.

## Características
- Acceso web a Ares Chat
- Cliente P2P compatible con la red Ares
